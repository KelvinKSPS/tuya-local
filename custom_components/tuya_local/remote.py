...
# Default RF carrier frequency for study mode.  433.92 MHz covers the vast
# majority of home-automation remotes.  Pass a different value (e.g. "315",
# "868") for devices that use another band.
...
class TuyaLocalRemote(TuyaLocalEntity, RemoteEntity):
    ...
    async def _async_learn_command(
        ...
        Args:
            ...
            rf_frequency: RF carrier frequency string forwarded to the hub's
                          study_feq field (e.g. "433.92", "315", "868").
                          Defaults to DEFAULT_RF_FREQUENCY.  "0" is avoided
                          because some hub firmware (e.g. S11+) interprets it
                          as "no frequency" and exits study mode prematurely.
        """
